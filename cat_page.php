...
<?php 
  ...
  {
    $id = $_REQUEST['id'];
    $data = mysqli_query($conn,"select category from categories where id='$id'");
...
?>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2><?php echo $datarow['category'] ?></h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <?php 
            ...
            FROM blogs
            JOIN categories
            ON categories.id=blogs.category where categories.id='$id' order by blogs.id DESC");
